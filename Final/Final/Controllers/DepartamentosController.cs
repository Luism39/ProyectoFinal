...
namespace Final.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Codigo,Nombre")] Departamentos departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Codigo,Nombre")] Departamentos departamento)
        {
            if (ModelState.IsValid)
            {
                try
